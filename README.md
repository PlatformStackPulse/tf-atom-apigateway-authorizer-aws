...
[![CI](https://github.com/PlatformStackPulse/tf-atom-apigateway-authorizer-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-apigateway-authorizer-aws/actions/workflows/ci.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)

## Purpose

Terraform atom: AWS API Gateway Authorizer - creates a Lambda/Cognito authorizer.
...
| <a name="input_authorizer_credentials"></a> [authorizer\_credentials](#input\_authorizer\_credentials) | IAM role ARN for invoking the authorizer | `string` | `null` | no |
| <a name="input_authorizer_uri"></a> [authorizer\_uri](#input\_authorizer\_uri) | URI of the authorizer Lambda function | `string` | `null` | no |
...
| <a name="input_identity_source"></a> [identity\_source](#input\_identity\_source) | Source of the identity token (e.g., method.request.header.Authorization) | `string` | `"method.request.header.Authorization"` | no |
...
| <a name="input_result_ttl"></a> [result\_ttl](#input\_result\_ttl) | TTL for cached authorizer results in seconds | `number` | `300` | no |
...
| <a name="input_type"></a> [type](#input\_type) | Authorizer type (TOKEN, REQUEST, COGNITO\_USER\_POOLS) | `string` | `"TOKEN"` | no |
...
| <a name="output_id"></a> [id](#output\_id) | ID of the authorizer |
<!-- END_TF_DOCS -->
